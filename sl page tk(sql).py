        ...
        for i in range(0,len(w)):
            ...
            if user== res['user']:
                ...
                if pincode in res['details']:
                    ...
                    global e142
                    e142=Label(frame14,text="wrong pincode",font=('Helvetica 22 bold'),borderwidth=2,bd=2,fg='red')
                    e142.place(x=600,y=300,height=30)
                    window.after(800,dele142)
            elif user != res['user']:
                continue
            else:
                continue
...
def entry_in_hotel():
    ...
    res={}
    foundz=False
    if E11.get()=='' or E12.get()=='' or E10.get()=='' or E19.get()=='':
        global e121
...
def parking_search():
        ...
        for i in range(0,len(w)):
            ...
            if user== res['user']:
                ...
                if pincode in res['details']:
                    ...
                    global e125
                    e125=Label(frame16,text="wrong pincode",font=('Helvetica 22 bold'),borderwidth=2,bd=2,fg='red')
                    e125.place(x=600,y=300,height=30)
                    window.after(800,dele125)
            elif user != res['user']:
                foundy=False
                continue
            else:
    ...
    if foundy==True:
        ...
        global e123
        e123=Label(frame16,text="username is wrong",font=('Helvetica 22 bold'),borderwidth=2,bd=2,fg='red')
...
def parking_entry():
    ...
    res={}
    foundz=False
    if E13.get()=='' or E14.get()=='' or E15.get()=='' or E22.get()=='':
        global e121
